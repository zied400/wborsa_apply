...
ENV p = new ENV(name: "PREPROD", eventType: "ws_available")
...
def builder = new JsonBuilder(p.SERVICES.collect {
    SERVICE a -> [eventType: "ws_available", environnement: "PREPROD", label: a.label, status: a.status, ok: a.ok, responsetime: a.responsetime, ip: a.ip, host: a.host]
})
